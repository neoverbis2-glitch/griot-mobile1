...
/** GitHub (plugin) */
export function GithubLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 1024 1024" fill="none" className={className} aria-hidden="true" {...props}>
      <path
        fill="#1b1f23"
        fillRule="evenodd"
...
/** GitLab (plugin) */
export function GitlabLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 32 32"
      fill="none"
...
/** Vercel (plugin) */
export function VercelLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 222"
...
/** Supabase (plugin) */
export function SupabaseLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 109 113" fill="none" className={className} aria-hidden="true" {...props}>
      <path
...
export function AzureLogo({ className = "size-5", ...props }: IconProps) {
  return (
...
/** Docker (plugin) */
export function DockerLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="#008fe2" className={className} aria-hidden="true" {...props}>
...
/** Sentry (plugin) */
export function SentryLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      preserveAspectRatio="xMidYMid"
      viewBox="0 0 256 227"
...
/** Linear (plugin) */
export function LinearLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg fill="none" viewBox="0 0 100 100" className={className} aria-hidden="true" {...props}>
      <path
        fill="#5E6AD2"
...
/** Trello (plugin) */
export function TrelloLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 63 63" className={className} aria-hidden="true" {...props}>
      <linearGradient id="trello__a" x1="50.048061%" x2="50.048061%" y1="100%">
...
/** Slack (plugin) */
export function SlackLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 2447.6 2452.5" className={className} aria-hidden="true" {...props}>
...
/** Notion (plugin) */
export function NotionLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      preserveAspectRatio="xMidYMid"
      viewBox="0 0 256 268"
...
/** Stripe (plugin) */
export function StripeLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg fill="none" viewBox="100 100 312 312" className={className} aria-hidden="true" {...props}>
      <path
        fill="#533afd"
        fillRule="evenodd"
...
/** Google Drive (plugin) */
export function GoogleDriveLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 87.3 78" className={className} aria-hidden="true" {...props}>
      <path
        fill="#0066da"
...
export function GoogleSheetsLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 74 100" fill="none" className={className} aria-hidden="true" {...props}>
      <mask
...
/** Gmail (plugin) */
export function GmailLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 49.4 512 399.42" className={className} aria-hidden="true" {...props}>
...
/** Neon (plugin) */
export function NeonLogo({ className = "size-5", ...props }: IconProps) {
  return (
...
/** MongoDB (plugin) */
export function MongoDbLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg fill="none" viewBox="0 0 120 258" className={className} aria-hidden="true" {...props}>
      <path
        fill="#001E2B"
...
/** PlanetScale (plugin) */
export function PlanetScaleLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      preserveAspectRatio="xMidYMid"
      viewBox="0 0 256 256"
...
/** Redis (plugin) */
export function RedisLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      preserveAspectRatio="xMidYMid"
      viewBox="0 0 256 220"
...
/** Upstash (plugin) */
export function UpstashLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 256 341"
      preserveAspectRatio="xMidYMid"
...
/** Qdrant (plugin) */
export function QdrantLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg fill="none" viewBox="0 0 57 64" className={className} aria-hidden="true" {...props}>
      <g clipPath="url(#qdrant_icon_light__a)">
        <path
          fill="#dc244c"
      ...
      <defs>
        <clipPath id="qdrant_icon_light__a">
...
/** Salesforce (plugin) */
export function SalesforceLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox=".5 .5 999 699.242" className={className} aria-hidden="true" {...props}>
      <path
        fill="#00A1E0"
...
/** Hugging Face (plugin) */
export function HuggingFaceLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 95 88"
    ...
    >
      ...
      <g id="hugging_face__Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
              ...
              <g id="hugging_face__Group-2">
                <g id="hugging_face__Group">
                  ...
                  <g id="hugging_face__Oval-4" transform="translate(33.500000, 41.500000)">
                    <g id="hugging_face__Mask" fillRule="nonzero" fill="#3A3B45">
                      <path
                        d="M13,14.7890193 C22.8284801,14.7890193 26,6.02605902 26,1.5261751 C26,-0.812484109 24.4279133,-0.0763570998 21.9099482,1.17020987 C19.5830216,2.32219957 16.4482998,3.91011313 13,3.91011313 C5.82029825,3.91011313 0,-2.97370882 0,1.5261751 C0,6.02605902 3.17151989,14.7890193 13,14.7890193 Z"
                        id="hugging_face__path-1"
                      />
...
/** Google Colab (plugin) */
export function GoogleColabLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
...
export function GoogleAnalyticsLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      version="1.1"
...
export function OutlookLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="60 90.4 570.02 539.67" className={className} aria-hidden="true" {...props}>
      <defs>
        <linearGradient
      ...
      <path
        ...
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__a)" }}
      />
      <path
        ...
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__b)" }}
      />
      <path
        d="M407.102 103.34a91.293 91.293 0 0 1 3.082 1.914l156.214 101.332-387.336 245.52-59.437-93.77L403.895 177.8c26.925-17.102 28.105-55.57 3.207-74.461Zm0 0"
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__c)" }}
      />
      <path
        ...
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__d)" }}
      />
      <path
        d="M333.602 498.988 179.066 452.11 507.63 243.836c27.672-17.54 27.601-57.938-.133-75.379l-1.48-.93 4.261 2.649 99.996 64.867a43.263 43.263 0 0 1 19.723 36.3v38.962Zm0 0"
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__e)" }}
      />
      <path
        ...
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__f)" }}
      />
      <path
        ...
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__g)" }}
      />
      <path
        d="M315.77 630.05h220.449c51.777 0 93.75-41.972 93.75-93.75V272.14c0 15.301-7.864 29.528-20.82 37.665l-327.907 205.89a60.712 60.712 0 0 0-28.422 51.414c.004 34.762 28.184 62.942 62.95 62.942Zm0 0"
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__h)" }}
      />
      <path
        d="M315.77 630.05h220.449c51.777 0 93.75-41.972 93.75-93.75V272.14c0 15.301-7.864 29.528-20.82 37.665l-327.907 205.89a60.712 60.712 0 0 0-28.422 51.414c.004 34.762 28.184 62.942 62.95 62.942Zm0 0"
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__i)" }}
      />
      <path
        ...
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__j)" }}
      />
      <path
        d="M405.402 630.035H183.738c-51.777 0-93.75-41.972-93.75-93.75v-264.34a44.473 44.473 0 0 0 20.754 37.621l327.582 206.52a61.737 61.737 0 0 1 28.809 52.226c-.004 34.09-27.64 61.723-61.73 61.723Zm0 0"
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__k)" }}
      />
      <path
        ...
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__l)" }}
      />
      <path
        d="M108.75 345h142.5c26.926 0 48.75 21.824 48.75 48.75v142.5c0 26.926-21.824 48.75-48.75 48.75h-142.5C81.824 585 60 563.176 60 536.25v-142.5C60 366.824 81.824 345 108.75 345Zm0 0"
        style={{ stroke: "none", fillRule: "nonzero", fill: "url(#microsoft_outlook__m)" }}
      />
      <path
...
/** Dropbox (plugin) */
export function DropboxLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg fill="none" viewBox="0 0 128 128" className={className} aria-hidden="true" {...props}>
...
/** Figma (plugin) */
export function FigmaLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 54 80" fill="none" className={className} aria-hidden="true" {...props}>
...
/** Canva (plugin) */
export function CanvaLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 80 80" fill="none" className={className} aria-hidden="true" {...props}>
...
/** Google Gemini (ai) */
export function GeminiAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 296 298" fill="none" className={className} aria-hidden="true" {...props}>
      <mask
        id="gemini__a"
        width="296"
        height="298"
...
/** Anthropic Claude (ai) */
export function ClaudeAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      preserveAspectRatio="xMidYMid"
      viewBox="0 0 256 257"
...
/** OpenAI ChatGPT (ai) */
export function OpenAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      preserveAspectRatio="xMidYMid"
      viewBox="0 0 256 260"
...
/** xAI Grok (ai) */
export function GrokAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 1024 1024" fill="none" className={className} aria-hidden="true" {...props}>
      <path
...
/** Groq (ai) */
export function GroqAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 201 201" className={className} aria-hidden="true" {...props}>
...
/** Moonshot Kimi (ai) */
export function KimiAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      viewBox="0 0 512 512"
      fillRule="evenodd"
...
/** DeepSeek (ai) */
export function DeepSeekAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
...
/** Perplexity (ai) */
export function PerplexityAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
...
/** Alibaba Qwen (ai) */
export function QwenAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      fill="currentColor"
      fillRule="evenodd"
...
/** Ollama (ai) */
export function OllamaAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg viewBox="0 0 646 854" fill="none" className={className} aria-hidden="true" {...props}>
      <path
...
/** Mistral AI (ai) */
export function MistralAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      preserveAspectRatio="xMidYMid"
      viewBox="0 0 256 233"
...
/** Meta AI (ai) */
export function MetaAiLogo({ className = "size-5", ...props }: IconProps) {
  return (
    <svg
      preserveAspectRatio="xMidYMid"
      viewBox="0 0 256 171"
...
export function getAiLogo(providerId?: string) {
  ...
  if (p.includes("grok") || p.includes("xai")) return GrokAiLogo;
  if (p.includes("groq")) return GroqAiLogo;
  if (p.includes("kimi") || p.includes("moonshot")) return KimiAiLogo;
  if (p.includes("deepseek")) return DeepSeekAiLogo;
  if (p.includes("perplexity") || p.includes("sonar")) return PerplexityAiLogo;
  if (p.includes("manus")) return ManusAiLogo;
  if (p.includes("qwen") || p.includes("alibaba")) return QwenAiLogo;
